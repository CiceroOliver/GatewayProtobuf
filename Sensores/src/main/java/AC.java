...
public class AC {
    ...
    public void seIdentificar(){
        try {
            ...
            String payload = "Modo: " + modo + "; Temperatura: " + Temperatura ;
    ...
    public void enviarAtualizacao(){
        try {
            // Criar a mensagem no formato id:status:payload
            String payload =  ID + "; " + "modo: " + modo + "; " + "Temperatura: " + Temperatura;
            ...
            while (true) {
                ...
                if (buffer.remaining() >= 4) {
                    ...
                    try {
                        ...
                        if("modo".equalsIgnoreCase(comando) && status && (message.getSensorId().equals(ID))){
