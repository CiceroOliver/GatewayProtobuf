...
public class SensorTemp {
    ...
    private double Temperatura = 25;
    private String ID = "Sensor Temperatura";
    ...
    public void seIdentificar(){
        try {
            // Criar a mensagem no formato id:status:payload
            String payload = "Dispositivo desligado: " + ID;
        ...
        while (true) {
            if (status) {            
                try {
                    ...
                    String payload = String.format("Temperatura: %.2f", (Temperatura + variacao));
            ...
            while (true) {
                ...
                if (buffer.remaining() >= 4) {
                    ...
                    try {
                        ...
                        // Exibe o status alterado apenas se houve mudança
                        if (status != oldStatus) {
                            System.out.println("Status atualizado: " + (status ? "Ligado" : "Desligado"));
                            enviarAtualizacao();
                        }
